...
public class MyOrderBean implements Serializable{
    ...
    public static class DatasBean {
        ...
        public static class OrderGroupListBean {
            /**
             * order_list : [{"order_id":"24","order_sn":"9000000000002701","pay_sn":"100540333120305003","pay_sn1":null,"store_id":"1","store_name":"好商城V5","buyer_id":"3","buyer_name":"fqx1111","buyer_email":"skyfan1991@163.com","buyer_phone":"12711350626","add_time":"1486989120","payment_code":"online","payment_time":"0","finnshed_time":"0","goods_amount":"52800.00","order_amount":"52800.00","rcb_amount":"0.00","pd_amount":"0.00","shipping_fee":"0.00","evaluation_state":"0","evaluation_again_state":"0","order_state":"10","refund_state":"0","lock_state":"0","delete_state":"0","refund_amount":"0.00","delay_time":"0","order_from":"2","shipping_code":"","order_type":"1","api_pay_time":"0","chain_id":"0","chain_code":"0","rpt_amount":"0.00","trade_no":null,"state_desc":"待付款","payment_name":"在线付款","extend_order_goods":[{"goods_id":"100009","goods_name":"劳力士Rolex 日志型系列 116200 63200 自动机械钢带男表联保正品","goods_price":"52800.00","goods_num":"1","goods_type":"1","goods_spec":null,"invite_rates":"0","goods_image_url":"http://169.254.252.234/data/upload/shop/store/goods/1/1_04752627958339099_240.jpg","refund":false}],"zengpin_list":[],"if_cancel":true,"if_refund_cancel":false,"if_receive":false,"if_lock":false,"if_deliver":false,"if_evaluation":false,"if_evaluation_again":false,"if_delete":false,"ownshop":true}]
             * pay_amount : 52800
             * add_time : 1486989120
             * pay_sn : 100540333120305003
             */
            ...
            public static class OrderListBean {
                 ...
                 * buyer_id : 3
                 * buyer_name : fqx1111
                 * buyer_email : skyfan1991@163.com
                 * buyer_phone : 12711350626
                 * add_time : 1486989120
                 * payment_code : online
                 * payment_time : 0
                 * finnshed_time : 0
                 * goods_amount : 52800.00
                 * order_amount : 52800.00
                 * rcb_amount : 0.00
                 * pd_amount : 0.00
                 * shipping_fee : 0.00
                 ...
                 * state_desc : 待付款
                 * payment_name : 在线付款
                 * extend_order_goods : [{"goods_id":"100009","goods_name":"劳力士Rolex 日志型系列 116200 63200 自动机械钢带男表联保正品","goods_price":"52800.00","goods_num":"1","goods_type":"1","goods_spec":null,"invite_rates":"0","goods_image_url":"http://169.254.252.234/data/upload/shop/store/goods/1/1_04752627958339099_240.jpg","refund":false}]
                 * zengpin_list : []
                 * if_cancel : true
                ...
                public static class ExtendOrderGoodsBean implements Serializable{
                     ...
                     * goods_spec : null
                     * invite_rates : 0
                     * goods_image_url : http://169.254.252.234/data/upload/shop/store/goods/1/1_04752627958339099_240.jpg
                     * refund : false
                     */
